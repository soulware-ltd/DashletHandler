...
$dashlet_storage = new DashletStorage();
$user_dashlets = $dashlet_storage->getDefaultRecords();
...
$sugar_smarty->assign('saved_dashlets', $user_dashlets);
...
$sugar_smarty->assign('lblLoadDashlets', $GLOBALS['mod_strings']['LBL_LOAD_DASHLETS']);
$sugar_smarty->assign('lblSaveDashlets', $GLOBALS['mod_strings']['LBL_SAVE_DASHLETS']);
$sugar_smarty->assign('mod_strings', $GLOBALS['mod_strings']);
